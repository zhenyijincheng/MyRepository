...
public class SampleApplicationLike extends DefaultApplicationLike {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(getApplication(),"补丁已经修复完成，请重启",Toast.LENGTH_SHORT).show();
        }
    };
...
//        Beta.installTinker(this);
        ...
        TinkerManager.TinkerPatchResultListener patchResultListener = new TinkerManager.TinkerPatchResultListener() {
            ...
            public void onPatchResult(PatchResult result) {
                ...
                Log.d(TAG,"onUpgrade:" + "  result:" + result.isSuccess);
                if (result.isSuccess) {
        ...
        Beta.upgradeListener = new UpgradeListener() {
            ...
            public void onUpgrade(int i, UpgradeInfo upgradeInfo, boolean b, boolean b1) {
                Log.d(TAG,"onUpgrade:" + "  i:" + i);
            }
        };
        Beta.upgradeStateListener = new UpgradeStateListener() {
            @Override
            public void onUpgradeFailed(boolean b) {
                Log.d(TAG,"onUpgradeFailed:" + "  b:" + b);
            }

            @Override
            public void onUpgradeSuccess(boolean b) {
                Log.d(TAG,"onUpgradeSuccess:" + "  b:" + b);

            }

            @Override
            public void onUpgradeNoVersion(boolean b) {
                Log.d(TAG,"onUpgradeNoVersion:" + "  b:" + b);

            }

            @Override
            public void onUpgrading(boolean b) {
                Log.d(TAG,"onUpgrading:" + "  b:" + b);

            }

            @Override
            public void onDownloadCompleted(boolean b) {
                Log.d(TAG,"onDownloadCompleted:" + "  b:" + b);
